...
class VOCDatasetMS(torch.utils.data.Dataset):
    CLASSES_NAME = (
        "__background__ ",
        "aeroplane",
        "bicycle",
    ...
    def __init__(self,root_dir,scale_mode='single',split='trainval',use_difficult=False,is_train=True, augment=None, mean=[0.5,0.5,0.5], std=[1.,1.,1.]):
        self.root=root_dir
        ...
        self.name2id=dict(zip(VOCDatasetMS.CLASSES_NAME,range(len(VOCDatasetMS.CLASSES_NAME))))
